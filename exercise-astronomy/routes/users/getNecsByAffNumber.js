const getNecsByAffNumber = require('../../queries/users')
...
module.exports = async (req, res, next) => {
    ...
    const result = await getNecsByAffNumber(id, {name, nickname, affiliatedNumber, affiliationDate, occupation, birthdate, deleted, astronomicalPoints, badges: {name, given, info, points}, neasDiscovered, necsDiscovered})
