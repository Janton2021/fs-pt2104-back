const {editNickAndOccupation} = require('../../queries/users')
...
module.exports = async (req, res, next) => {
    ...
    const result = await editNickAndOccupation(id, {name, nickname, affiliatedNumber, affiliationDate, occupation, birthdate, deleted, astronomicalPoints, badges: {name, given, info, points}, neasDiscovered, necsDiscovered})
